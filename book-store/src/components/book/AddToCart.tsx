...
function AddToCart({book}: Props) {
    ...
    return (
        <AddToCartStyle $added={cartAdded}>
            ...
            <Button size="medium" scheme="primary" onClick={() => addToCart(quantity)}>장바구니</Button>
            {cartAdded && (
                <div className="added">
                    <p>장바구니에 추가되었습니다.</p>
...
interface AddToCartStyledProps {
    $added: boolean
}

const AddToCartStyle = styled.div<AddToCartStyledProps>`
    display: flex;
