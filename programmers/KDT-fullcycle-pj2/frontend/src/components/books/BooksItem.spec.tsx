...
describe('BooksItem 컴포넌트', () => {
  ...
  describe('책 정보가 주어지면', () => {
    it('렌더링 되어야 합니다.', () => {
      ...
      const imageElement = screen.getByRole('img', {
        name: dummyBook.title,
      });
      expect(imageElement).toHaveAttribute('src', `https://picsum.photos/id/${dummyBook.img}/600/600`);
    });
  });
  ...
  describe('책 이미지가 주어지면 ', () => {
    it('스타일이 올바르게 적용되어야 합니다.', () => {
      ...
      expect(container).toHaveAttribute('src', 'https://picsum.photos/id/5/600/600');
